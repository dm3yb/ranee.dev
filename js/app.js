	...
	resources: {
		...
		ru: {
			translation: {
				...
				"analyzeDesc": "Анализ полученного проекта с целью рассмотрения возможностей реализации, уточнения требований заказчика.",
				"ExecutionTestingTitle": "Выполнение & Тестирование",
				"ExecutionTestingDesc": "Написание сайта с учетом интересов клиента, выявления проблем и определения путей их решения, исходя из полученного дизайна.",
		...
		sk: {
			translation: {
				...
				"heroSloganParagraph1": "Je  to stránka o mne, mojom portfóliu a mojich schopnostiach .. ",
				"heroSloganParagraph2": "v skratke „stránka vizitka“",
				"btnCV": "Stiahnuť životopis",
				"aboutParagraph1": "Áhoj! Volám sa Dmytro. Ja som mlády, ambiciózny a cieľavedomý webový vývojár. ",
				"aboutParagraph2": "Kto je webový vývojár? Webový vývojár je programátor, ktorý vytvára a udržiava webové stránky s ohľadom na záujmy klienta a spotrebiteľa. To znamená, že konečný výsledok musí obsahovať produkty a služby.",
				"aboutParagraph3": "Prečo ja? Dokážem napísať moderné a efektívné webové stránky v krátkom čase. Používam moderné webové knižnice a frameworky. Nakoniec mám vedomosti z oblasti dizajnu.",
				"aboutParagraph4": "Ak vás to zaujímalo, choďte nižšie a pozrite, s čím pracujem a čo môžem robiť.",
				"howIWorks": "Ako som pracujú?",
				"analyzeTitle": "Analyzovanie práci",
				"analyzeDesc": "Analýza získaného projektu kvôli prejednávaniu možností realizácie, podľa upresnených požiadaviek zákazníka.",
				"ExecutionTestingTitle": "Splnenie & Testovanie",
				"ExecutionTestingDesc": "Písanie webovej stránky s ohľadom na záujmy zákazníka, zistenie problémov a určenie spôsobov riešenia na základe získaného dizajnu.",
				"PublishTitle": "Publikácia",
				"PublishDesc": "Presvedčiť sa, že požiadavky zákazníka sú v súlade s konečným výsledkom. Stránka je adaptívna a rýchla. Neskôr sa trafí v internet.",
				"btnTemplate": "Viac šablónov",
				"questionsTitle": "Máte otázky?",
				"questionsDesc": "Ako sa zistilo, toto sú najčastejšie otázky .. otvorte ich a získajte odpovede!",
				"questions1": "Prečo ja?",
				"questions1Desc": "Dokážem napísať moderné a efektívné webové stránky v krátkom čase. Používam moderné webové knižnice a frameworky. Nakoniec mám vedomosti z oblasti dizajnu.",
				"questions2": "Koľko stojí vytvoriť webové stránky?",
				"questions2Desc": "Od počiatku beriem do úvahy rozsah práce a to, aké služby budú použité pre konkrétny projekt / aplikáciu. Cena bude oznámená neskôr.",
				"questions3": "Ake stránky som robím?",
				"questions3Desc": "V podstate beriem na seba všetky projekty .. všetko závisí od času ktoré potrebujem na napísanie stránky / aplikácie.",
